  ...
  return (
    <nav className='bg-blue-200 flex justify-between'>
        ...
        <div className='flex space-x-4 items-center'>
            <button className='p-5 font-medium text-lg hover:text-blue-500' onClick={() => {navigate("/")}}>
                Dashboard
            </button>
        ...
        <div className='flex items-center mr-2 p-2'>
            <div className='bg-blue-900 border rounded-full h-12 w-12 text-white flex items-center justify-center'>
